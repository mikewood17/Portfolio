        ...
        <div class="grid">
            <header class="grid-item">
                <div class="heading">
                    <div class="intro">
                        ...
                        <div>
                            <img class="hero-img" src="img/avatar-img.png">
                        </div>
                        <h2>
            ...
            <nav class="nav grid-item hidden-xxs hidden-xs hidden-sm">
                <div class=" nav-container container">
                    ...
                    <div class="socials">
                        <a href="https://twitter.com/michael_wood17"><i class="social-icon fa-brands fa-twitter"></i></a>
                        <a href="https://www.instagram.com/mew_illustration/"><i class="social-icon fa-brands fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/in/michael-wood-a0b622256/"><i class="social-icon fa-brands fa-linkedin-in"></i></a>
                        <a href="https://github.com/mikewood17"><i class="social-icon fa-brands fa-github"></i></a>
                    </div>
                </div>
            </nav>
            ...
            <main class="primary content grid-item container">
                ...
                <div class="row container" id="portfolio">
                    <div class="item-1 col">
                        <div class="img-container">
                            <img  class="project-img" src="img/coming-soon.jpg">
                        </div>
