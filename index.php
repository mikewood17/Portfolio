        ...
        <div class="grid">
            ...
            <header class="grid-item">
                <div class="heading">
                    ...
                    <div class="scroll">
                        ...
                        <a href="index.html#portfolio"><i class="fa-solid fa-arrow-down"></i></a>
                    </div>
                </div>
            </header>
            ...
            <main class="primary content grid-item container">
                ...
                <div class="mobile-nav">
                    ...
                    <div>
                        <a href="index.html#contact-form">Contact Me</a>
                    </div>
                </div>
                    <div class="row container">
                        <div class="item-1 col">
                            ...
                            <div class="project-name">
                                <span>Project One: HTML, CSS, 
                                    <br>JavaScript Reflection</span>
                            </div>
                            <div>
                                <a href="https://mikewood17.github.io/Netmatters-Reflection-Project-1/" target="_blank" class="btn project-btn">
                        ...
                        <div class="item-2 col">
                            ...
                            <div class="project-name">
                                <span>Project Two: JavaScript Array
                                    <br> Reflection</span>
                            </div>
                            <div>
                    ...
                    <div class="contact-form grid-item">
                        <form class="form" id="form">
                            <div class="contact-input">
                                ...
                                <input class="form-control" type="text" placeholder="John" id="first-name">
                            ...
                            <div class="contact-input">
                                ...
                                <input class="form-control" type="text" placeholder="Smith" id="last-name">
                                <i class="fa-solid fa-circle-check"></i>
                                <i class="fa-solid fa-circle-exclamation"></i>
                                <small>Error message</small>
                            </div>
                            <div class="contact-input">
                                ...
                                <input class="form-control" type="text" placeholder="John.smith@example.com" id="email">
                                <i class="fa-solid fa-circle-check"></i>
                                <i class="fa-solid fa-circle-exclamation"></i>
                                <small>Error message</small>
                            </div>
                            <div class="contact-input">
                                ...
                                <input class="form-control" type="text" placeholder="Enter Subject here" id="subject" maxlength="50">
                                <i class="fa-solid fa-circle-check"></i>
                                <i class="fa-solid fa-circle-exclamation"></i>
                                <small>Error message</small>
                            </div>
                            <div class="contact-input">
                                ...
                                <textarea class="form-control message" type="text" placeholder="Enter Message here" id="message" maxlength="400"></textarea>
                                <i class="fa-solid fa-circle-check"></i>
                                <i class="fa-solid fa-circle-exclamation"></i>
                                <small>Error message</small>
                            </div>
